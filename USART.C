...
void UART1_int (void) interrupt UART1_VECTOR
{
	if(RI)
	{
		...
		if(COM1.B_RX_OK == 0)
		{
			...
			if(RX1_Buffer[(COM1.RX_Cnt+COM_RX1_Lenth-3)%COM_RX1_Lenth] == 't' && RX1_Buffer[(COM1.RX_Cnt+COM_RX1_Lenth-2)%COM_RX1_Lenth] == 'e' && RX1_Buffer[(COM1.RX_Cnt+COM_RX1_Lenth-1)%COM_RX1_Lenth] == 's' && RX1_Buffer[COM1.RX_Cnt] == 't')
			{
				if(RX1_Buffer[(COM1.RX_Cnt+COM_RX1_Lenth-6)%COM_RX1_Lenth] == 'v' && RX1_Buffer[(COM1.RX_Cnt+COM_RX1_Lenth-5)%COM_RX1_Lenth] == 'c')
					set_mode(VC_TEST);
				else if(RX1_Buffer[(COM1.RX_Cnt+COM_RX1_Lenth-6)%COM_RX1_Lenth] == 'i' && RX1_Buffer[(COM1.RX_Cnt+COM_RX1_Lenth-5)%COM_RX1_Lenth] == 'o')
				{	
					set_mode(GPIO_TEST);
					set_mode(GPIO_NEXT);
					WATER_Number = 254;
			...
			if(RX1_Buffer[(COM1.RX_Cnt+COM_RX1_Lenth-3)%COM_RX1_Lenth] == 'n' && RX1_Buffer[(COM1.RX_Cnt+COM_RX1_Lenth-2)%COM_RX1_Lenth] == 'e' && RX1_Buffer[(COM1.RX_Cnt+COM_RX1_Lenth-1)%COM_RX1_Lenth] == 'x' && RX1_Buffer[COM1.RX_Cnt] == 't')
			{
				set_mode(GPIO_NEXT);
				WATER_Number++;
				if(WATER_Number > 27 && WATER_Number < 254)
					WATER_Number = 254;
			}
			
			if(RX1_Buffer[(COM1.RX_Cnt+COM_RX1_Lenth-2)%COM_RX1_Lenth] == 'e' && RX1_Buffer[(COM1.RX_Cnt+COM_RX1_Lenth-1)%COM_RX1_Lenth] == 'n' && RX1_Buffer[COM1.RX_Cnt] == 'd')
				set_mode(GPIO_END);
